...
define("waimai:widget/common/userinfo/UserMgr.js", function(i, e, t) {
    ...
    function(e) {
        ...
        c = {
            ...
            login: function(i) {
                i = i || {}, c.userState.isOnline && c.userState.isOnline == _ && (c.userState.displayname || "") + (c.userState.email || "") + (c.userState.mobile || "") ? i.url && (location.href = i.url) : o(i)
            },
            logout: function() {
