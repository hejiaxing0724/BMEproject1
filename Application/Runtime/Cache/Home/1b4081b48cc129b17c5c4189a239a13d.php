...
<div class = "jumbotron">
    <div style="margin-top:25px"class ="container">
    	<a href="<?php echo U('Admin/indexadminjj');?>">
        <div style="width:150px"class="alert alert-info" >编辑评价系统简介</div>
      </a>
      <a href="<?php echo U('Admin/indexadminsf');?>">
        <div style="width:150px"class="alert alert-info" >编辑相关算法简介</div>
      </a>
      <a href="<?php echo U('Admin/indexadminzb');?>">
        <div style="width:150px"class="alert alert-info" >编辑指标</div>
      </a>
    	<a href="<?php echo U('Admin/indexadminsj');?>">
        <div style="width:150px"class="alert alert-info" >数据录入</div>
      </a>
